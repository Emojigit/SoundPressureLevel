...
@DesignerComponent(version = 20230527,
...
public class SoundPressureLevel extends AndroidNonvisibleComponent
    ...
    Thread soundChecker;
    private Runnable soundCheckerRunnable;
    ...
    public SoundPressureLevel(ComponentContainer container) {
        ...
        soundCheckerRunnable = new Runnable(){
            @Override
            public void run() {
                while(threadRunning){
        ...
        soundChecker = new Thread(soundCheckerRunnable);
    ...
    public void onResume() {
        if (isEnabled) {
            ...
            if (threadSuspended) {
                ...
                /* try {
                    soundCheckerRunnable.notify();
                } catch (java.lang.IllegalMonitorStateException e) {
                    Log.d(LOG_TAG,"spl error notifying");
                } */
            }
        }
    }
